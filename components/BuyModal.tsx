...
export default function BuyModal() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (phone.replace(/\D/g, '').length < 8) { setMsg('That phone number looks too short.'); return }
    ...
    const save = submitForm('ticket-order', {
      first_name: firstName, last_name: rest.join(' '), email, whatsapp: phone,
      ...
      <div className="bm-card" role="dialog" aria-modal="true" aria-labelledby="bm-title">
        ...
        <form onSubmit={onSubmit} noValidate>
          ...
          <div className="bm-row">
            ...
            <label className="sr-only" htmlFor="bm_phone">Phone Number</label>
            <input id="bm_phone" name="phone" type="tel" inputMode="tel" autoComplete="tel" placeholder="Phone Number" />
          </div>
          <div className="check">
